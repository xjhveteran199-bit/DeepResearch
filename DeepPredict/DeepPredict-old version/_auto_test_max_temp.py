# -*- coding: utf-8 -*-
"""
DeepPredict 自动调试脚本 — 每日最高温度 (Daily Max Temperatures)
数据集: Daily Max Temperatures in Melbourne
来源: https://raw.githubusercontent.com/jbrownlee/Datasets/master/daily-max-temperatures.csv
"""
import pandas as pd
import numpy as np
...
print('=' * 60)
print('DeepPredict 自动调试 — 每日最高温度 Melbourne Max Temps')
print('=' * 60)
...
# ============================================================
print('\n>>> 步骤1: 加载每日最高温度数据集...')
csv_path = r'data\daily_max_temperatures.csv'
...
try:
    ...
    success, msg = lstm.train(y_train_scaled, y_train_scaled, seq_len=lstm_seq, epochs=20)
    if not success:
...
# 保存结果
results_file = r'auto_test_max_temp_results.json'
with open(results_file, 'w', encoding='utf-8') as f:
    json.dump({
        'dataset': 'daily_max_temperatures',
        'source': 'https://raw.githubusercontent.com/jbrownlee/Datasets/master/daily-max-temperatures.csv',
        'n_samples': int(len(y)),
